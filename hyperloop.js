...
Opal.modules["hyperloop/component/version"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      return Opal.const_set($nesting[0], 'VERSION', "1.0.0.lap24")
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting)
};
...
Opal.modules["react/hash"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Hash_initialize_1;

    
    self.$alias_method("_pre_react_patch_initialize", "initialize");
    return (Opal.defn(self, '$initialize', TMP_Hash_initialize_1 = function $$initialize(defaults) {
      var self = this, $iter = TMP_Hash_initialize_1.$$p, block = $iter || nil;

      if ($iter) TMP_Hash_initialize_1.$$p = null;
      if ($truthy(defaults===null)) {
        return $send(self, '_pre_react_patch_initialize', [], block.$to_proc())
        } else {
        return $send(self, '_pre_react_patch_initialize', [defaults], block.$to_proc())
      }
    }, TMP_Hash_initialize_1.$$arity = -1), nil) && 'initialize';
  })($nesting[0], null, $nesting)
};
...
if (tag == null) tag = nil;
          ...
          if (tag['$==']("p")) {
            $send(self, 'define_method', [tag], (TMP_3 = function($a_rest){var self = TMP_3.$$s || this, children, params, $b, $c;
            ...
            $send(self, 'define_method', [tag], (TMP_4 = function($a_rest){var self = TMP_4.$$s || this, children, params;
            ...
            return $send(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'RenderingContext'), 'render', [tag].concat(Opal.to_a(params)), children.$to_proc())}, TMP_4.$$s = self, TMP_4.$$arity = -1, TMP_4))
          };
          self.$alias_method(tag.$upcase(), tag);
          return self.$const_set(tag.$upcase(), tag);}, TMP_Tags_2.$$s = self, TMP_Tags_2.$$arity = 1, TMP_Tags_2));
...
Opal.modules["react/validator"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      Opal.defn(self, '$allow_undefined_props=', TMP_Validator_allow_undefined_props$eq_6 = function(allow) {
        var self = this;

        return (self.allow_undefined_props = allow)
      }, TMP_Validator_allow_undefined_props$eq_6.$$arity = 1);
      
      Opal.defn(self, '$undefined_props', TMP_Validator_undefined_props_8 = function $$undefined_props(props) {
        var TMP_7, self = this, $writer = nil;

        
        
        $writer = [true];
        $send(self, 'allow_undefined_props=', Opal.to_a($writer));
        $writer[$rb_minus($writer["length"], 1)];;
        return $send(props, 'reject', [], (TMP_7 = function(name, value){var self = TMP_7.$$s || this;
if (name == null) name = nil;if (value == null) value = nil;
        return self.$rules()['$[]'](name)}, TMP_7.$$s = self, TMP_7.$$arity = 2, TMP_7));
      }, TMP_Validator_undefined_props_8.$$arity = 1);
...
Opal.modules["react/callbacks"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$extend', '$each', '$callbacks_for', '$class', '$is_a?', '$instance_exec', '$to_proc', '$send', '$define_singleton_method', '$set_var', '$concat', '$push', '$+', '$respond_to?', '$superclass']);
...
if (callback == null) callback = nil;
      ...
      (function($base, $parent_nesting) {
        ...
        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_ClassMethods_define_callback_7, TMP_ClassMethods_callbacks_for_8;

        
        
        Opal.defn(self, '$define_callback', TMP_ClassMethods_define_callback_7 = function $$define_callback(callback_name) {
          var TMP_4, TMP_6, self = this, $iter = TMP_ClassMethods_define_callback_7.$$p, $yield = $iter || nil, wrapper_name = nil;

          if ($iter) TMP_ClassMethods_define_callback_7.$$p = null;
          
          wrapper_name = "" + "_" + (callback_name) + "_callbacks";
          $send(self, 'define_singleton_method', [wrapper_name], (TMP_4 = function(){var self = TMP_4.$$s || this, TMP_5;

          return $send(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Hyperloop'), 'Context'), 'set_var', [self, "" + "@" + (wrapper_name), $hash2(["force"], {"force": true})], (TMP_5 = function(){var self = TMP_5.$$s || this;

            return []}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5))}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4));
          return $send(self, 'define_singleton_method', [callback_name], (TMP_6 = function($a_rest){var self = TMP_6.$$s || this, block, args;
        ...
        }, TMP_ClassMethods_define_callback_7.$$arity = 1);
...
Opal.modules["react/rendering_context"] = function(Opal) {
  ...
  (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      return (function(self, $parent_nesting) {
        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_render_1, TMP_build_9, TMP_delete_10, TMP_rendered$q_11, TMP_replace_12, TMP_remove_nodes_from_args_14, TMP_run_child_block_15, TMP_raise_render_error_16, TMP_improper_render_17;
...
if (key == null) key = nil;if (value == null) value = nil;
        ...
        Opal.defn(self, '$run_child_block', TMP_run_child_block_15 = function $$run_child_block(is_outer_scope) {
          var $a, $b, self = this, $iter = TMP_run_child_block_15.$$p, $yield = $iter || nil, result = nil;
          if (self.buffer == null) self.buffer = nil;
        ...
        Opal.defn(self, '$raise_render_error', TMP_raise_render_error_16 = function $$raise_render_error(result) {
          var self = this;
          if (self.buffer == null) self.buffer = nil;
        ...
        }, TMP_raise_render_error_16.$$arity = 1);
        return (Opal.defn(self, '$improper_render', TMP_improper_render_17 = function $$improper_render(message, solution) {
          var self = this;

          return self.$raise("" + "a component's render method must generate and return exactly 1 element or a string.\n" + ("" + "    " + (message) + "  " + (solution)))
        }, TMP_improper_render_17.$$arity = 2), nil) && 'improper_render';
      })(Opal.get_singleton_class(self), $nesting)
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Object_18, TMP_Object_para_21, TMP_Object_br_24;

    
    $send(["span", "td", "th", "while_loading"], 'each', [], (TMP_Object_18 = function(tag){var self = TMP_Object_18.$$s || this, TMP_19;
if (tag == null) tag = nil;
    return $send(self, 'define_method', [tag], (TMP_19 = function($a_rest){var self = TMP_19.$$s || this, block, args, TMP_20;

        block = TMP_19.$$p || nil;
        if (block) TMP_19.$$p = null;
        var $args_len = arguments.length, $rest_len = $args_len - 0;
        if ($rest_len < 0) { $rest_len = 0; }
        args = new Array($rest_len);
        for (var $arg_idx = 0; $arg_idx < $args_len; $arg_idx++) {
        ...
        return $send(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'RenderingContext'), 'render', Opal.to_a(args), (TMP_20 = function(){var self = TMP_20.$$s || this;

        return self.$to_s()}, TMP_20.$$s = self, TMP_20.$$arity = 0, TMP_20));}, TMP_19.$$s = self, TMP_19.$$arity = -1, TMP_19))}, TMP_Object_18.$$s = self, TMP_Object_18.$$arity = 1, TMP_Object_18));
    
    Opal.defn(self, '$para', TMP_Object_para_21 = function $$para($a_rest) {
      var TMP_22, self = this, args, $iter = TMP_Object_para_21.$$p, block = $iter || nil;
      ...
      if ($iter) TMP_Object_para_21.$$p = null;
      
      args.$unshift("p");
      if ($truthy(self['$is_a?'](Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'Component')))) {
        return $send(self, 'send', Opal.to_a(args), block.$to_proc())};
      return $send(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'RenderingContext'), 'render', Opal.to_a(args), (TMP_22 = function(){var self = TMP_22.$$s || this;

      return self.$to_s()}, TMP_22.$$s = self, TMP_22.$$arity = 0, TMP_22));
    }, TMP_Object_para_21.$$arity = -1);
    return (Opal.defn(self, '$br', TMP_Object_br_24 = function $$br() {
      var TMP_23, self = this;

      
      if ($truthy(self['$is_a?'](Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'Component')))) {
        return self.$send("br")};
      return $send(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'RenderingContext'), 'render', ["span"], (TMP_23 = function(){var self = TMP_23.$$s || this;

      
        Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'RenderingContext').$render(self.$to_s());
        return Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'RenderingContext').$render("br");}, TMP_23.$$s = self, TMP_23.$$arity = 0, TMP_23));
    }, TMP_Object_br_24.$$arity = 0), nil) && 'br';
  })($nesting[0], null, $nesting);
};
...
Opal.modules["hyper-store/version"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    Opal.const_set($nesting[0], 'VERSION', "1.0.0.lap24")
  })($nesting[0], $nesting)
};
...
Opal.modules["react/component/api"] = function(Opal) {
  ...
  Opal.add_stubs(['$raise', '$set_or_replace_state_or_prop', '$to_proc', '$private', '$shallow_to_n', '$call']);
  return (function($base, $parent_nesting) {
    var $React, self = $React = $module($base, 'React');
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      (function($base, $parent_nesting) {
        ...
        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_ClassMethods_deprecation_warning_1, TMP_ClassMethods_reactrb_component$q_2, TMP_ClassMethods_backtrace_3, TMP_ClassMethods_append_backtrace_5, TMP_ClassMethods_render_6, TMP_ClassMethods_method_missing_10, TMP_ClassMethods_validator_11, TMP_ClassMethods_prop_types_12, TMP_ClassMethods_default_props_13, TMP_ClassMethods_params_14, TMP_ClassMethods_props_wrapper_15, TMP_ClassMethods_param_16, TMP_ClassMethods_collect_other_params_as_19, TMP_ClassMethods_define_state_20, TMP_ClassMethods_export_state_23, TMP_ClassMethods_native_mixin_27, TMP_ClassMethods_native_mixins_28, TMP_ClassMethods_static_call_back_29, TMP_ClassMethods_static_call_backs_30, TMP_ClassMethods_export_component_31, TMP_ClassMethods_imports_33, TMP_ClassMethods_add_item_to_tree_35, TMP_ClassMethods_to_n_36;
...
if (line == null) line = nil;
        ...
        Opal.defn(self, '$collect_other_params_as', TMP_ClassMethods_collect_other_params_as_19 = function $$collect_other_params_as(name) {
          var TMP_17, TMP_18, self = this, $writer = nil, validator_in_lexical_scope = nil, validator_in_lexial_scope = nil;

          
          
          $writer = [true];
          $send(self.$validator(), 'allow_undefined_props=', Opal.to_a($writer));
          $writer[$rb_minus($writer["length"], 1)];;
          validator_in_lexical_scope = self.$validator();
          $send(self.$props_wrapper(), 'define_method', [name], (TMP_17 = function(){var self = TMP_17.$$s || this, $a;
            if (self._all_others == null) self._all_others = nil;

          return (self._all_others = ($truthy($a = self._all_others) ? $a : validator_in_lexical_scope.$undefined_props(self.$props())))}, TMP_17.$$s = self, TMP_17.$$arity = 0, TMP_17));
          validator_in_lexial_scope = self.$validator();
          return $send(self.$props_wrapper(), 'define_method', [name], (TMP_18 = function(){var self = TMP_18.$$s || this, $a;
            if (self._all_others == null) self._all_others = nil;

          return (self._all_others = ($truthy($a = self._all_others) ? $a : validator_in_lexial_scope.$undefined_props(self.$props())))}, TMP_18.$$s = self, TMP_18.$$arity = 0, TMP_18));
        }, TMP_ClassMethods_collect_other_params_as_19.$$arity = 1);
        
        Opal.defn(self, '$define_state', TMP_ClassMethods_define_state_20 = function $$define_state($a_rest) {
          var $b, TMP_21, TMP_22, self = this, states, $iter = TMP_ClassMethods_define_state_20.$$p, block = $iter || nil, default_initial_value = nil, states_hash = nil;
          ...
          if ($iter) TMP_ClassMethods_define_state_20.$$p = null;
          ...
          $send(states, 'each', [], (TMP_21 = function(name){var self = TMP_21.$$s || this;
if (name == null) name = nil;
          return self.$state($hash(name, default_initial_value))}, TMP_21.$$s = self, TMP_21.$$arity = 1, TMP_21));
          return $send(states_hash, 'each', [], (TMP_22 = function(name, value){var self = TMP_22.$$s || this;
if (name == null) name = nil;if (value == null) value = nil;
          return self.$state($hash(name, value))}, TMP_22.$$s = self, TMP_22.$$arity = 2, TMP_22));
        }, TMP_ClassMethods_define_state_20.$$arity = -1);
        
        Opal.defn(self, '$export_state', TMP_ClassMethods_export_state_23 = function $$export_state($a_rest) {
          var $b, TMP_24, TMP_25, self = this, states, $iter = TMP_ClassMethods_export_state_23.$$p, block = $iter || nil, default_initial_value = nil, states_hash = nil;
          ...
          if ($iter) TMP_ClassMethods_export_state_23.$$p = null;
          ...
          $send(states, 'each', [], (TMP_24 = function(name){var self = TMP_24.$$s || this, $writer = nil;
if (name == null) name = nil;
          ...
          return $send(states_hash, 'each', [], (TMP_25 = function(name, value){var self = TMP_25.$$s || this, TMP_26;
if (name == null) name = nil;if (value == null) value = nil;
          
            self.$state($hash(name, value, "scope", "class", "reader", true));
            return $send(self.$singleton_class(), 'define_method', ["" + (name) + "!"], (TMP_26 = function($a_rest){var self = TMP_26.$$s || this, args;
            ...
            return $send(self.$mutate(), '__send__', [name].concat(Opal.to_a(args)))}, TMP_26.$$s = self, TMP_26.$$arity = -1, TMP_26));}, TMP_25.$$s = self, TMP_25.$$arity = 2, TMP_25));
        }, TMP_ClassMethods_export_state_23.$$arity = -1);
        
        Opal.defn(self, '$native_mixin', TMP_ClassMethods_native_mixin_27 = function $$native_mixin(item) {
          var self = this;

          return self.$native_mixins()['$<<'](item)
        }, TMP_ClassMethods_native_mixin_27.$$arity = 1);
        
        Opal.defn(self, '$native_mixins', TMP_ClassMethods_native_mixins_28 = function $$native_mixins() {
          var $a, self = this;
          if (self.native_mixins == null) self.native_mixins = nil;

          return (self.native_mixins = ($truthy($a = self.native_mixins) ? $a : []))
        }, TMP_ClassMethods_native_mixins_28.$$arity = 0);
        
        Opal.defn(self, '$static_call_back', TMP_ClassMethods_static_call_back_29 = function $$static_call_back(name) {
          var self = this, $iter = TMP_ClassMethods_static_call_back_29.$$p, block = $iter || nil, $writer = nil;

          if ($iter) TMP_ClassMethods_static_call_back_29.$$p = null;
          
          $writer = [name, block];
          $send(self.$static_call_backs(), '[]=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];
        }, TMP_ClassMethods_static_call_back_29.$$arity = 1);
        
        Opal.defn(self, '$static_call_backs', TMP_ClassMethods_static_call_backs_30 = function $$static_call_backs() {
          var $a, self = this;
        ...
        }, TMP_ClassMethods_static_call_backs_30.$$arity = 0);
        
        Opal.defn(self, '$export_component', TMP_ClassMethods_export_component_31 = function $$export_component(opts) {
          ...
          return $writer[$rb_minus($writer["length"], 1)];;
        }, TMP_ClassMethods_export_component_31.$$arity = -1);
        
        Opal.defn(self, '$imports', TMP_ClassMethods_imports_33 = function $$imports(component_name) {
          var TMP_32, self = this, e = nil;
          ...
          try {
            ...
            return $send(self, 'define_method', ["render"], (TMP_32 = function(){var self = TMP_32.$$s || this;

            return nil}, TMP_32.$$s = self, TMP_32.$$arity = 0, TMP_32));
          } catch ($err) {
            if (Opal.rescue($err, [Opal.const_get_relative($nesting, 'Exception')])) {e = $err;
              try {
        ...
        }, TMP_ClassMethods_imports_33.$$arity = 1);
        
        Opal.defn(self, '$add_item_to_tree', TMP_ClassMethods_add_item_to_tree_35 = function $$add_item_to_tree(current_tree, new_item) {
          var $a, TMP_34, self = this, $writer = nil;
          ...
          if ($truthy(($truthy($a = self.$Native(current_tree).$class()['$!='](Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Native'), 'Object'))) ? $a : new_item.$length()['$=='](1)))) {
            return $send(new_item, 'inject', [], (TMP_34 = function(a, e){var self = TMP_34.$$s || this;
if (a == null) a = nil;if (e == null) e = nil;
            return $hash(e, a)}, TMP_34.$$s = self, TMP_34.$$arity = 2, TMP_34))
            } else {
        ...
        }, TMP_ClassMethods_add_item_to_tree_35.$$arity = 2);
        
        Opal.defn(self, '$to_n', TMP_ClassMethods_to_n_36 = function $$to_n() {
          var self = this;

          return Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'API').$class_eval("@@component_classes")['$[]'](self)
        }, TMP_ClassMethods_to_n_36.$$arity = 0);
      })($nesting[0], $nesting)
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      (function($base, $super, $parent_nesting) {
        ...
        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_PropsWrapper_define_param_7, TMP_PropsWrapper_initialize_8, TMP_PropsWrapper_$$_9, TMP_PropsWrapper_fetch_from_cache_10, TMP_PropsWrapper_cache_13, TMP_PropsWrapper_props_14, TMP_PropsWrapper_value_for_15;
...
if (param == null) param = nil;
        ...
        Opal.defn(self, '$initialize', TMP_PropsWrapper_initialize_8 = function $$initialize(component) {
          var self = this;

          return (self.component = component)
        }, TMP_PropsWrapper_initialize_8.$$arity = 1);
        
        Opal.defn(self, '$[]', TMP_PropsWrapper_$$_9 = function(prop) {
          var self = this;

          return self.$props()['$[]'](prop)
        }, TMP_PropsWrapper_$$_9.$$arity = 1);
        self.$private();
        
        Opal.defn(self, '$fetch_from_cache', TMP_PropsWrapper_fetch_from_cache_10 = function $$fetch_from_cache(name) {
          var $a, $b, TMP_11, self = this, $iter = TMP_PropsWrapper_fetch_from_cache_10.$$p, $yield = $iter || nil, last = nil, value = nil;

          if ($iter) TMP_PropsWrapper_fetch_from_cache_10.$$p = null;
          
          $b = self.$cache()['$[]'](name), $a = Opal.to_ary($b), (last = ($a[0] == null ? nil : $a[0])), (value = ($a[1] == null ? nil : $a[1])), $b;
          if ($truthy(last['$equal?'](self.$props()['$[]'](name)))) {
            return value};
          return $send(Opal.yieldX($yield, []), 'tap', [], (TMP_11 = function(value){var self = TMP_11.$$s || this, $writer = nil;
if (value == null) value = nil;
        ...
        }, TMP_PropsWrapper_fetch_from_cache_10.$$arity = 1);
        
        Opal.defn(self, '$cache', TMP_PropsWrapper_cache_13 = function $$cache() {
          var $a, TMP_12, self = this;

          return (self.cache = ($truthy($a = self.cache) ? $a : $send(Opal.const_get_relative($nesting, 'Hash'), 'new', [], (TMP_12 = function(h, k){var self = TMP_12.$$s || this, $writer = nil;
if (h == null) h = nil;if (k == null) k = nil;
          
            $writer = [k, []];
            $send(h, '[]=', Opal.to_a($writer));
            return $writer[$rb_minus($writer["length"], 1)];}, TMP_12.$$s = self, TMP_12.$$arity = 2, TMP_12))))
        }, TMP_PropsWrapper_cache_13.$$arity = 0);
        
        Opal.defn(self, '$props', TMP_PropsWrapper_props_14 = function $$props() {
          var self = this;

          return self.$component().$props()
        }, TMP_PropsWrapper_props_14.$$arity = 0);
        return (Opal.defn(self, '$value_for', TMP_PropsWrapper_value_for_15 = function $$value_for(name) {
          var self = this;
        ...
        }, TMP_PropsWrapper_value_for_15.$$arity = 1), nil) && 'value_for';
      })($nesting[0], null, $nesting)
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
...
Opal.modules["react/component"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$include', '$class_eval', '$class_attribute', '$define_callback', '$extend', '$deprecation_warning', '$name', '$class', '$init_store', '$include?', '$event_camelize', '$to_s', '$call', '$[]', '$params', '$on_opal_client?', '$load_context', '$set_state_context_to', '$run_callback', '$update_states_to_observe', '$remove', '$==', '$callbacks_for', '$attr_reader', '$set_state', '$method_defined?', '$raise', '$render', '$respond_to?', '$waiting_on_resources', '$new', '$initialize_states', '$define_state', '$to_proc', '$<<', '$log']);
  ...
  (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      return (function($base, $parent_nesting) {
        ...
        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Mixin_included_2, TMP_Mixin_deprecation_warning_3, TMP_Mixin_deprecation_warning_4, TMP_Mixin_initialize_5, TMP_Mixin_emit_6, TMP_Mixin_component_will_mount_8, TMP_Mixin_component_did_mount_10, TMP_Mixin_component_will_receive_props_12, TMP_Mixin_component_will_update_14, TMP_Mixin_component_did_update_16, TMP_Mixin_component_will_unmount_18, TMP_Mixin_component_did_catch_20, TMP_Mixin_update_react_js_state_21, TMP_Mixin_set_state_synchronously$q_22, TMP_Mixin_render_23, TMP_Mixin__render_wrapper_26, TMP_Mixin_watch_27, TMP_Mixin_define_state_28;

        
        Opal.defs(self, '$included', TMP_Mixin_included_2 = function $$included(base) {
          var TMP_1, self = this;
          ...
          $send(base, 'class_eval', [], (TMP_1 = function(){var self = TMP_1.$$s || this;
            ...
            return self.$define_callback("after_error");}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1));
        ...
        }, TMP_Mixin_included_2.$$arity = 1);
        Opal.defs(self, '$deprecation_warning', TMP_Mixin_deprecation_warning_3 = function $$deprecation_warning(message) {
          var self = this;

          return Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'Component').$deprecation_warning(self.$name(), message)
        }, TMP_Mixin_deprecation_warning_3.$$arity = 1);
        
        Opal.defn(self, '$deprecation_warning', TMP_Mixin_deprecation_warning_4 = function $$deprecation_warning(message) {
          var self = this;
        ...
        }, TMP_Mixin_deprecation_warning_4.$$arity = 1);
        
        Opal.defn(self, '$initialize', TMP_Mixin_initialize_5 = function $$initialize(native_element) {
          var self = this;

          
          self["native"] = native_element;
          return self.$init_store();
        }, TMP_Mixin_initialize_5.$$arity = 1);
        
        Opal.defn(self, '$emit', TMP_Mixin_emit_6 = function $$emit(event_name, $a_rest) {
        ...
        }, TMP_Mixin_emit_6.$$arity = -2);
        
        Opal.defn(self, '$component_will_mount', TMP_Mixin_component_will_mount_8 = function $$component_will_mount() {
          var TMP_7, self = this;
          ...
          return $send(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'State'), 'set_state_context_to', [self], (TMP_7 = function(){var self = TMP_7.$$s || this;

          return self.$run_callback("before_mount")}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7));
        }, TMP_Mixin_component_will_mount_8.$$arity = 0);
        
        Opal.defn(self, '$component_did_mount', TMP_Mixin_component_did_mount_10 = function $$component_did_mount() {
          var TMP_9, self = this;

          return $send(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'State'), 'set_state_context_to', [self], (TMP_9 = function(){var self = TMP_9.$$s || this;

          
            self.$run_callback("after_mount");
            return Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'State').$update_states_to_observe();}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9))
        }, TMP_Mixin_component_did_mount_10.$$arity = 0);
        
        Opal.defn(self, '$component_will_receive_props', TMP_Mixin_component_will_receive_props_12 = function $$component_will_receive_props(next_props) {
          ...
          return self.$run_callback("before_receive_props", next_props)}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11))
        }, TMP_Mixin_component_will_receive_props_12.$$arity = 1);
        
        Opal.defn(self, '$component_will_update', TMP_Mixin_component_will_update_14 = function $$component_will_update(next_props, next_state) {
          var TMP_13, self = this;
          ...
          return self.$run_callback("before_update", next_props, next_state)}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13))
        }, TMP_Mixin_component_will_update_14.$$arity = 2);
        
        Opal.defn(self, '$component_did_update', TMP_Mixin_component_did_update_16 = function $$component_did_update(prev_props, prev_state) {
          var TMP_15, self = this;

          return $send(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'State'), 'set_state_context_to', [self], (TMP_15 = function(){var self = TMP_15.$$s || this;

          
            self.$run_callback("after_update", prev_props, prev_state);
            return Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'State').$update_states_to_observe();}, TMP_15.$$s = self, TMP_15.$$arity = 0, TMP_15))
        }, TMP_Mixin_component_did_update_16.$$arity = 2);
        
        Opal.defn(self, '$component_will_unmount', TMP_Mixin_component_will_unmount_18 = function $$component_will_unmount() {
          var TMP_17, self = this;

          return $send(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'State'), 'set_state_context_to', [self], (TMP_17 = function(){var self = TMP_17.$$s || this;

          
            self.$run_callback("before_unmount");
            return Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'State').$remove();}, TMP_17.$$s = self, TMP_17.$$arity = 0, TMP_17))
        }, TMP_Mixin_component_will_unmount_18.$$arity = 0);
        
        Opal.defn(self, '$component_did_catch', TMP_Mixin_component_did_catch_20 = function $$component_did_catch(error, info) {
          var TMP_19, self = this;
          ...
          if (self.$class().$callbacks_for("after_error")['$==']([])) {
              if ($truthy(typeof error.$backtrace === "function")) {
                return console.error(error.$backtrace().$join("\n"))
                } else {
                return console.error(error, info)
              }
              } else {
              return self.$run_callback("after_error", error, info)
            }}, TMP_19.$$s = self, TMP_19.$$arity = 0, TMP_19))
        }, TMP_Mixin_component_did_catch_20.$$arity = 2);
        self.$attr_reader("waiting_on_resources");
        
        Opal.defn(self, '$update_react_js_state', TMP_Mixin_update_react_js_state_21 = function $$update_react_js_state(object, name, value) {
          var self = this;
        ...
        }, TMP_Mixin_update_react_js_state_21.$$arity = 3);
        
        Opal.defn(self, '$set_state_synchronously?', TMP_Mixin_set_state_synchronously$q_22 = function() {
          var self = this;
          if (self["native"] == null) self["native"] = nil;

          return self["native"]["__opalInstanceSyncSetState"]
        }, TMP_Mixin_set_state_synchronously$q_22.$$arity = 0);
        if ($truthy(self['$method_defined?']("render"))) {
          } else {
          
          Opal.defn(self, '$render', TMP_Mixin_render_23 = function $$render() {
            var self = this;

            return self.$raise("no render defined")
          }, TMP_Mixin_render_23.$$arity = 0)
        };
        
        Opal.defn(self, '$_render_wrapper', TMP_Mixin__render_wrapper_26 = function $$_render_wrapper() {
          var TMP_24, self = this;

          return $send(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'State'), 'set_state_context_to', [self, true], (TMP_24 = function(){var self = TMP_24.$$s || this, TMP_25, element = nil;

          
            element = $send(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'RenderingContext'), 'render', [nil], (TMP_25 = function(){var self = TMP_25.$$s || this, $a;

            return ($truthy($a = self.$render()) ? $a : "")}, TMP_25.$$s = self, TMP_25.$$arity = 0, TMP_25));
            if ($truthy(element['$respond_to?']("waiting_on_resources"))) {
              self.waiting_on_resources = element.$waiting_on_resources()};
            return element;}, TMP_24.$$s = self, TMP_24.$$arity = 0, TMP_24))
        }, TMP_Mixin__render_wrapper_26.$$arity = 0);
        
        Opal.defn(self, '$watch', TMP_Mixin_watch_27 = function $$watch(value) {
          var self = this, $iter = TMP_Mixin_watch_27.$$p, on_change = $iter || nil;

          if ($iter) TMP_Mixin_watch_27.$$p = null;
          return Opal.const_get_relative($nesting, 'Observable').$new(value, on_change)
        }, TMP_Mixin_watch_27.$$arity = 1);
        
        Opal.defn(self, '$define_state', TMP_Mixin_define_state_28 = function $$define_state($a_rest) {
          var self = this, args, $iter = TMP_Mixin_define_state_28.$$p, block = $iter || nil;
          ...
          if ($iter) TMP_Mixin_define_state_28.$$p = null;
        ...
        }, TMP_Mixin_define_state_28.$$arity = -1);
      })($nesting[0], $nesting)
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Component_included_29, TMP_Component_deprecation_warning_30;

      
      Opal.defs(self, '$included', TMP_Component_included_29 = function $$included(base) {
        var self = this;
      ...
      }, TMP_Component_deprecation_warning_30.$$arity = 2);
    })($nesting[0], $nesting);
    (function($base, $parent_nesting) {
      var $ComponentNoNotice, self = $ComponentNoNotice = $module($base, 'ComponentNoNotice');

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_ComponentNoNotice_included_31;

      Opal.defs(self, '$included', TMP_ComponentNoNotice_included_31 = function $$included(base) {
        var self = this;

        return base.$include(Opal.const_get_qualified(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Hyperloop'), 'Component'), 'Mixin'))
      }, TMP_ComponentNoNotice_included_31.$$arity = 1)
    })($nesting[0], $nesting);
  })($nesting[0], $nesting);
  return (function($base, $parent_nesting) {
    var $React, self = $React = $module($base, 'React');
...
Opal.modules["react/children"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Children_initialize_1, TMP_Children_each_2, TMP_Children_length_4;
      ...
      Opal.defn(self, '$each', TMP_Children_each_2 = function $$each() {
        var TMP_3, self = this, $iter = TMP_Children_each_2.$$p, block = $iter || nil, collection = nil, element = nil;

        if ($iter) TMP_Children_each_2.$$p = null;
        
        if ((block !== nil)) {
          } else {
          return $send(self, 'to_enum', ["each"], (TMP_3 = function(){var self = TMP_3.$$s || this;

          return self.$length()}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3))
        };
      ...
      ;
        return collection;
      }, TMP_Children_each_2.$$arity = 0);
      
      Opal.defn(self, '$length', TMP_Children_length_4 = function $$length() {
        var $a, self = this;

        return (self.length = ($truthy($a = self.length) ? $a : React.Children.count(self.children)))
      }, TMP_Children_length_4.$$arity = 0);
...
if (event_name == null) event_name = nil;
      ...
      Opal.defn(self, '$merge_built_in_event_prop!', TMP_Element_merge_built_in_event_prop$B_12 = function(prop_name) {
        ...
        return self.properties['$merge!']($hash(prop_name, 
          function(event){
            return Opal.yield1($yield, Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'Event').$new(event))
          }
        ))
...
Opal.modules["react/event"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      return (Opal.defn(self, '$initialize', TMP_Event_initialize_1 = function $$initialize(native_element) {
        var self = this;
...
Opal.modules["react/api"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$instance_variable_set', '$[]=', '$-', '$raise', '$eval_native_react_component', '$!', '$method_defined?', '$[]', '$respond_to?', '$native_mixins', '$to_n', '$static_call_backs', '$new', '$name', '$default_props', '$prop_types', '$<<', '$is_a?', '$create_native_react_class', '$include?', '$convert_props', '$shallow_to_n', '$flatten', '$each', '$==', '$lower_camelize', '$to_key', '$call', '$tr', '$html_attr?', '$private', '$split', '$first', '$join', '$concat', '$map', '$+', '$upcase']);
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_API_import_native_component_1, TMP_API_eval_native_react_component_2, TMP_API_native_react_component$q_3, TMP_API_create_native_react_class_4, TMP_API_create_element_5, TMP_API_clear_component_class_cache_6, TMP_API_convert_props_9, TMP_API_lower_camelize_11;
      ...
      Opal.defs(self, '$create_native_react_class', TMP_API_create_native_react_class_4 = function $$create_native_react_class(type) {
        var $a, $b, self = this, render_fn = nil, $writer = nil;
        ...
        return ($truthy($a = (($b = $API.$$cvars['@@component_classes']) == null ? nil : $b)['$[]'](type)) ? $a : (($writer = [type, 
      ...
      ]), $send((($b = $API.$$cvars['@@component_classes']) == null ? nil : $b), '[]=', Opal.to_a($writer)), $writer[$rb_minus($writer["length"], 1)]));
      }, TMP_API_create_native_react_class_4.$$arity = 1);
      Opal.defs(self, '$create_element', TMP_API_create_element_5 = function $$create_element(type, properties) {
        var $a, self = this, $iter = TMP_API_create_element_5.$$p, block = $iter || nil, params = nil, ncc = nil, a = nil;

        if (properties == null) {
          properties = $hash2([], {});
        }
        if ($iter) TMP_API_create_element_5.$$p = null;
        
        params = [];
        ncc = (($a = $API.$$cvars['@@component_classes']) == null ? nil : $a)['$[]'](type);
        if ($truthy(ncc)) {
          params['$<<'](ncc)
        } else if ($truthy(type['$is_a?'](Opal.const_get_relative($nesting, 'Class')))) {
          params['$<<'](self.$create_native_react_class(type))
        } else if ($truthy(($truthy($a = (block !== nil)) ? $a : Opal.const_get_qualified(Opal.const_get_qualified(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'Component'), 'Tags'), 'HTML_TAGS')['$include?'](type)))) {
          params['$<<'](type)
      ...
      }, TMP_API_create_element_5.$$arity = -2);
      Opal.defs(self, '$clear_component_class_cache', TMP_API_clear_component_class_cache_6 = function $$clear_component_class_cache() {
        var self = this;

        return (Opal.class_variable_set($API, '@@component_classes', $hash2([], {})))
      }, TMP_API_clear_component_class_cache_6.$$arity = 0);
      Opal.defs(self, '$convert_props', TMP_API_convert_props_9 = function $$convert_props(properties) {
        var TMP_7, self = this, props = nil;

        
        if ($truthy(properties['$is_a?'](Opal.const_get_relative($nesting, 'Hash')))) {
          } else {
          self.$raise("" + "Component parameters must be a hash. Instead you sent " + (properties))
        };
        props = $hash2([], {});
        $send(properties, 'each', [], (TMP_7 = function(key, value){var self = TMP_7.$$s || this, $a, TMP_8, $writer = nil;
if (key == null) key = nil;if (value == null) value = nil;
        if ($truthy(($truthy($a = key['$==']("class")) ? $a : key['$==']("class_name")))) {
            
            $writer = ["className", value];
            $send(props, '[]=', Opal.to_a($writer));
            return $writer[$rb_minus($writer["length"], 1)];
          } else if ($truthy(["style", "dangerously_set_inner_HTML"]['$include?'](key))) {
            ...
            return $send(value, 'each', [], (TMP_8 = function(k, v){var self = TMP_8.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
            
              $writer = ["" + (key) + "-" + (k.$tr("_", "-")), v.$to_n()];
              $send(props, '[]=', Opal.to_a($writer));
              return $writer[$rb_minus($writer["length"], 1)];}, TMP_8.$$s = self, TMP_8.$$arity = 2, TMP_8))
            } else {
        ...
        return props;
      }, TMP_API_convert_props_9.$$arity = 1);
      self.$private();
      return Opal.defs(self, '$lower_camelize', TMP_API_lower_camelize_11 = function $$lower_camelize(snake_cased_word) {
        var TMP_10, self = this, words = nil, result = nil;

        
        words = snake_cased_word.$split("_");
        result = [words.$first()];
        return result.$concat($send(words['$[]']($range(1, -1, false)), 'map', [], (TMP_10 = function(word){var self = TMP_10.$$s || this;
if (word == null) word = nil;
        return $rb_plus(word['$[]'](0).$upcase(), word['$[]']($range(1, -1, false)))}, TMP_10.$$s = self, TMP_10.$$arity = 1, TMP_10))).$join("");
      }, TMP_API_lower_camelize_11.$$arity = 1);
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
};
...
Opal.modules["react/object"] = function(Opal) {
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Number_to_key_3;

    return (Opal.defn(self, '$to_key', TMP_Number_to_key_3 = function $$to_key() {
      var self = this;

      return self
    }, TMP_Number_to_key_3.$$arity = 0), nil) && 'to_key'
  })($nesting[0], null, $nesting);
  return (function($base, $super, $parent_nesting) {
    function $Boolean(){};
    var self = $Boolean = $klass($base, $super, 'Boolean', $Boolean);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Boolean_to_key_4;

    return (Opal.defn(self, '$to_key', TMP_Boolean_to_key_4 = function $$to_key() {
      var self = this;

      return self
    }, TMP_Boolean_to_key_4.$$arity = 0), nil) && 'to_key'
  })($nesting[0], null, $nesting);
};
...
Opal.modules["react/ext/opal-jquery/element"] = function(Opal) {
  ...
  if ($truthy(Opal.const_get_relative($nesting, 'Object')['$const_defined?']("Element"))) {
    return $send(Opal.const_get_relative($nesting, 'Element'), 'instance_eval', [], (TMP_1 = function(){var self = TMP_1.$$s || this, TMP_find_2, TMP_$$_3, TMP_4;
      ...
      return $send(self, 'define_method', ["render"], (TMP_4 = function(container, params){var self = TMP_4.$$s || this, block, TMP_5, klass = nil;
        ...
        return Opal.const_get_relative($nesting, 'React').$render(Opal.const_get_relative($nesting, 'React').$create_element(self.$to_n()._reactrb_component_class), self);}, TMP_4.$$s = self, TMP_4.$$arity = -1, TMP_4));}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1))
    } else {
    return nil
  }
};
  ...
  if (Opal.const_get_relative($nesting, 'RUBY_ENGINE')['$==']("opal")) {
    return (function($base, $parent_nesting) {
      ...
      (function($base, $parent_nesting) {
        ...
        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Config_environment$eq_1, TMP_Config_config_2;

        
        self.$extend(self);
        
        Opal.defn(self, '$environment=', TMP_Config_environment$eq_1 = function(value) {
          var self = this;

          return self.$raise("Environment cannot be configured at runtime.")
        }, TMP_Config_environment$eq_1.$$arity = 1);
        
        Opal.defn(self, '$config', TMP_Config_config_2 = function $$config() {
...
Opal.modules["reactive-ruby/isomorphic_helpers"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$extend', '$!=', '$!', '$unique_id', '$on_opal_server?', '$log', '$new', '$is_a?', '$==', '$[]', '$config', '$+', '$class', '$on_opal_client?', '$join', '$collect', '$prerender_footer_blocks', '$call', '$attr_reader', '$[]=', '$-', '$run', '$each', '$before_first_mount_blocks', '$send_to_opal', '$eval', '$length', '$load!', '$tr', '$<<', '$first', '$send_to_server', '$to_json', '$parse', '$controller', '$context', '$register_before_first_mount_block', '$to_proc', '$register_prerender_footer_block', '$send', '$result']);
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      Opal.defs(self, '$log', TMP_IsomorphicHelpers_log_4 = function $$log(message, message_type) {
        var $a, $b, self = this, is_production = nil, style = nil;
        ...
        is_production = Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'Config').$config()['$[]']("environment")['$==']("production");
        if ($truthy(($truthy($a = ($truthy($b = message_type['$==']("info")) ? $b : message_type['$==']("warning"))) ? is_production : $a))) {
          return nil};
...
Opal.modules["rails-helpers/top_level_rails_component"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$export_component', '$param', '$backtrace', '$start_with?', '$component_name', '$params', '$<<', '$const_get', '$each', '$search_path', '$class', '$name', '$controller', '$!=', '$method_defined?', '$render', '$render_params', '$raise', '$join', '$search_path=', '$-', '$!', '$include?', '$add_to_react_search_path']);
  ...
  (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_TopLevelRailsComponent_search_path_1, TMP_TopLevelRailsComponent_render_4;
      ...
      self.$backtrace("off");
      return (Opal.defn(self, '$render', TMP_TopLevelRailsComponent_render_4 = function $$render() {
        var TMP_2, TMP_3, $a, self = this, paths_searched = nil, component = nil;
        ...
        if ($truthy(self.$params().$component_name()['$start_with?']("::"))) {
          ...
          (function(){var $brk = Opal.new_brk(); try {return $send(self.$class().$search_path(), 'each', [], (TMP_2 = function(scope){var self = TMP_2.$$s || this;
if (scope == null) scope = nil;
            ...
            if ($truthy(component['$!='](nil))) {
              ...
              return nil
            };}, TMP_2.$$s = self, TMP_2.$$brk = $brk, TMP_2.$$arity = 1, TMP_2))
          } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})();
          if ($truthy(component)) {
            } else {
...
if (scope == null) scope = nil;
      ...
      }, TMP_TopLevelRailsComponent_render_4.$$arity = 0), nil) && 'render';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  (function($base, $super, $parent_nesting) {
    function $Module(){};
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Module_add_to_react_search_path_5;

    return (Opal.defn(self, '$add_to_react_search_path', TMP_Module_add_to_react_search_path_5 = function $$add_to_react_search_path(replace_search_path) {
      var self = this, $writer = nil;
    ...
    }, TMP_Module_add_to_react_search_path_5.$$arity = -1), nil) && 'add_to_react_search_path'
  })($nesting[0], null, $nesting);
  return (function($base, $parent_nesting) {
...
Opal.modules["hyper-react"] = function(Opal) {
  var $a, $b, $c, self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $hash2 = Opal.hash2, $module = Opal.module, $klass = Opal.klass, $truthy = Opal.truthy;

  Opal.add_stubs(['$require', '$import', '$==', '$raise', '$join', '$include', '$deprecation_warning']);
  
  self.$require("hyperloop-config");
  Opal.const_get_relative($nesting, 'Hyperloop').$import("hyper-store");
  Opal.const_get_relative($nesting, 'Hyperloop').$import("react/react-source-browser", $hash2(["client_only"], {"client_only": true}));
  Opal.const_get_relative($nesting, 'Hyperloop').$import("react/react-source-server", $hash2(["server_only"], {"server_only": true}));
  Opal.const_get_relative($nesting, 'Hyperloop').$import("browser/delay", $hash2(["client_only"], {"client_only": true}));
  Opal.const_get_relative($nesting, 'Hyperloop').$import("hyper-react");
  Opal.const_get_relative($nesting, 'Hyperloop').$import("react_ujs");
  if (Opal.const_get_relative($nesting, 'RUBY_ENGINE')['$==']("opal")) {
    ...
    if ($truthy(Opal.global.React === undefined || Opal.global.React.version === undefined)) {
    ...
    if ($truthy((($c = Opal.const_get_relative($nesting, 'Hyperloop', 'skip_raise')) && ($b = Opal.const_get_qualified($c, 'Component', 'skip_raise')) && ($a = Opal.const_get_qualified($b, 'VERSION', 'skip_raise')) ? 'constant' : nil))) {
      return nil
      } else {
      return Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'Component').$deprecation_warning("component.rb", "Requiring 'hyper-react' is deprecated.  Use gem 'hyper-component', and require 'hyper-component' instead.")
    };
    } else {
    return nil
  };
...
Opal.modules["hyper-component"] = function(Opal) {
  ...
  self.$require("hyperloop-config");
  Opal.const_get_relative($nesting, 'Hyperloop').$import("hyper-component");
  if (Opal.const_get_relative($nesting, 'RUBY_ENGINE')['$==']("opal")) {
...
Opal.modules["mutations/version"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    Opal.const_set($nesting[0], 'VERSION', "0.8.1")
  })($nesting[0], $nesting)
};
      ...
      return (Opal.defn(self, '$filter', TMP_HashFilter_filter_17 = function $$filter(data) {
        ...
        if ($truthy(data['$nil?']())) {
          ...
          if ($truthy(self.$options()['$[]']("nils"))) {
            return [nil, nil]};
          return [nil, "nils"];};
        if ($truthy(data['$is_a?'](Opal.const_get_relative($nesting, 'Hash')))) {
          } else {
          return [data, "hash"]
        };
        ...
        return $send(inputs, 'each_pair', [], (TMP_15 = function(key, filterer){var self = TMP_15.$$s || this, $a, $b, data_element = nil, sub_data = nil, sub_error = nil, $writer = nil;
if (key == null) key = nil;if (filterer == null) filterer = nil;
            ...
            if ($truthy(data['$has_key?'](key)['$!']())) {
              if ($truthy(filterer['$has_default?']())) {
                ...
                $writer = [key, Opal.const_get_relative($nesting, 'ErrorAtom').$new(key, "required")];
                $send(errors, '[]=', Opal.to_a($writer));
                return $writer[$rb_minus($writer["length"], 1)];
                } else {
                return nil
...
Opal.modules["mutations/array_filter"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_ArrayFilter_register_additional_filter_2, TMP_ArrayFilter_initialize_3, TMP_ArrayFilter_hash_4, TMP_ArrayFilter_model_5, TMP_ArrayFilter_array_6, TMP_ArrayFilter_filter_8, TMP_ArrayFilter_filter_element_9;
      ...
      Opal.defn(self, '$filter', TMP_ArrayFilter_filter_8 = function $$filter(data) {
...
if (el == null) el = nil;if (i == null) i = nil;
      ...
      return (Opal.defn(self, '$filter_element', TMP_ArrayFilter_filter_element_9 = function $$filter_element(data) {
        ...
        if ($truthy(self.element_filter)) {
          ...
          if ($truthy(class_const['$is_a?'](Opal.const_get_relative($nesting, 'String')))) {
...
Opal.modules["mutations/command"] = function(Opal) {
  ...
  Opal.add_stubs(['$send', '$input_filters', '$to_proc', '$each', '$define_method', '$[]', '$has_key?', '$[]=', '$-', '$private', '$create_attr_methods', '$run', '$new', '$run!', '$validation_outcome', '$==', '$superclass', '$dup', '$inject', '$with_indifferent_access', '$is_a?', '$raise', '$merge!', '$filter', '$has_errors?', '$validate', '$class', '$!', '$nil?', '$execute', '$success?', '$result', '$errors', '$protected', '$attr_reader', '$tap', '$split', '$to_s', '$pop', '$to_sym', '$any?']);
  return (function($base, $parent_nesting) {
    var $Mutations, self = $Mutations = $module($base, 'Mutations');
...
if (response == null) response = nil;
              ...
              Opal.const_get_relative($nesting, 'Hyperloop').$action_cable_consumer().subscriptions.create(
                ...
                },
                {
                  connected: function() {
                    ...
                    Opal.const_get_relative($nesting, 'ClientDrivers').$get_queued_data("connect-to-transport", channel_string)
                  },
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_ClientDrivers_sync_dispatch_14, TMP_ClientDrivers_15, TMP_ClientDrivers_17, TMP_ClientDrivers_get_queued_data_22, TMP_ClientDrivers_initialize_client_drivers_on_boot_27, TMP_ClientDrivers_polling_path_28;
...
if (f == null) f = nil;
      ...
      Opal.defs(self, '$get_queued_data', TMP_ClientDrivers_get_queued_data_22 = function $$get_queued_data(operation, channel, opts) {
        ...
        return $send(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Hyperloop'), 'HTTP').$get(self.$polling_path(operation, channel), opts), 'then', [], (TMP_20 = function(response){var self = TMP_20.$$s || this, TMP_21;
if (response == null) response = nil;
        return $send(response.$json(), 'each', [], (TMP_21 = function(data){var self = TMP_21.$$s || this;
if (data == null) data = nil;
            ...
            return self.$sync_dispatch(data['$[]'](1));}, TMP_21.$$s = self, TMP_21.$$arity = 1, TMP_21))}, TMP_20.$$s = self, TMP_20.$$arity = 1, TMP_20))
      }, TMP_ClientDrivers_get_queued_data_22.$$arity = -2);
      Opal.defs(self, '$initialize_client_drivers_on_boot', TMP_ClientDrivers_initialize_client_drivers_on_boot_27 = function $$initialize_client_drivers_on_boot() {
        var $a, TMP_23, TMP_24, TMP_25, TMP_26, self = this, $writer = nil, h = nil, pusher_api = nil;
        ...
        if ($truthy(self.initialized)) {
          ...
          if ($truthy(($truthy($a = self['$on_opal_client?']()) ? Opal.const_get_relative($nesting, 'Hyperloop').$action_cable_consumer() : $a))) {
            $send(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Hyperloop'), 'HTTP'), 'get', ["" + (window.HyperloopEnginePath) + "/server_up"], (TMP_23 = function(){var self = TMP_23.$$s || this;
        ...
        if ($truthy(self['$on_opal_client?']())) {
          ...
          if (self.$opts()['$[]']("transport")['$==']("pusher")) {
            ...
            $writer = ["dispatch", $send(self, 'lambda', [], (TMP_24 = function(data){var self = TMP_24.$$s || this;
if (data == null) data = nil;
            return self.$sync_dispatch(Opal.const_get_relative($nesting, 'JSON').$parse(JSON.stringify(data)))}, TMP_24.$$s = self, TMP_24.$$arity = 1, TMP_24))];
            ...
            $send(self.$opts()['$[]']("auto_connect"), 'each', [], (TMP_25 = function(channel){var self = TMP_25.$$s || this;
if (channel == null) channel = nil;
            return $send(Opal.const_get_relative($nesting, 'IncomingBroadcast'), 'add_connection', Opal.to_a(channel))}, TMP_25.$$s = self, TMP_25.$$arity = 1, TMP_25));
            return $send(self, 'every', [self.$opts()['$[]']("seconds_between_poll")], (TMP_26 = function(){var self = TMP_26.$$s || this;

            return self.$get_queued_data("read", nil)}, TMP_26.$$s = self, TMP_26.$$arity = 0, TMP_26));
            } else {
            return nil
          };
          } else {
      ...
      }, TMP_ClientDrivers_initialize_client_drivers_on_boot_27.$$arity = 0);
      return Opal.defs(self, '$polling_path', TMP_ClientDrivers_polling_path_28 = function $$polling_path(to, id) {
        var self = this, s = nil;
        ...
        if ($truthy(id)) {
          s = "" + (s) + "/" + (id)};
        return s;
      }, TMP_ClientDrivers_polling_path_28.$$arity = -2);
    })($nesting[0], null, $nesting);
  })($nesting[0], $nesting)
};
...
Opal.modules["hyper-operation/server_op"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      return (function(self, $parent_nesting) {
        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_run_3, TMP_run_4, TMP_5, TMP_descendants_map_cache_7, TMP_run_from_client_11, TMP_remote_12, TMP_serialize_params_13, TMP_deserialize_params_14, TMP_serialize_response_15, TMP_deserialize_response_16, TMP_serialize_dispatch_17, TMP_deserialize_dispatch_18, TMP_dispatch_to_19, TMP_dispatch_from_server_21;
          ...
          try {
            ...
            if ($truthy(Opal.const_get_relative($nesting, 'Rails').$env()['$production?']())) {
              if ($truthy(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Hyperloop'), 'ServerOp').$descendants_map_cache()['$include?'](operation))) {
                ...
                Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Hyperloop'), 'InternalPolicy').$raise_operation_access_violation()
              }
              } else {
            ...
            return $send(operation.$constantize(), 'class_eval', [], (TMP_8 = function(){var self = TMP_8.$$s || this, TMP_9, TMP_10, $writer = nil;
              ...
              return $send($send(self.$run(params), 'then', [], (TMP_9 = function(r){var self = TMP_9.$$s || this;
if (r == null) r = nil;
...
if (e == null) e = nil;
                ...
                Opal.const_get_qualified('::', 'Rails').$logger().$debug("" + "\e[0;31;1mERROR: Hyperloop::ServerOp failed when running " + (operation) + " with params \"" + (params) + "\": " + (e) + "\e[0;30;21m");
                Opal.ret($hash2(["json", "status"], {"json": $hash2(["error"], {"error": e}), "status": 500}));}, TMP_10.$$s = self, TMP_10.$$arity = 1, TMP_10));}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8));
          } catch ($err) {
            if (Opal.rescue($err, [Opal.const_get_relative($nesting, 'Exception')])) {e = $err;
              try {
        ...
        Opal.defn(self, '$remote', TMP_remote_12 = function $$remote(path, $a_rest) {
        ...
        }, TMP_remote_12.$$arity = -2);
        
        Opal.defn(self, '$serialize_params', TMP_serialize_params_13 = function $$serialize_params(hash) {
          var self = this;

          return hash
        }, TMP_serialize_params_13.$$arity = 1);
        
        Opal.defn(self, '$deserialize_params', TMP_deserialize_params_14 = function $$deserialize_params(hash) {
          var self = this;

          return hash
        }, TMP_deserialize_params_14.$$arity = 1);
        
        Opal.defn(self, '$serialize_response', TMP_serialize_response_15 = function $$serialize_response(hash) {
          var self = this;

          return hash
        }, TMP_serialize_response_15.$$arity = 1);
        
        Opal.defn(self, '$deserialize_response', TMP_deserialize_response_16 = function $$deserialize_response(hash) {
          var self = this;

          return hash
        }, TMP_deserialize_response_16.$$arity = 1);
        
        Opal.defn(self, '$serialize_dispatch', TMP_serialize_dispatch_17 = function $$serialize_dispatch(hash) {
          var self = this;

          return hash
        }, TMP_serialize_dispatch_17.$$arity = 1);
        
        Opal.defn(self, '$deserialize_dispatch', TMP_deserialize_dispatch_18 = function $$deserialize_dispatch(hash) {
          var self = this;

          return hash
        }, TMP_deserialize_dispatch_18.$$arity = 1);
        
        Opal.defn(self, '$dispatch_to', TMP_dispatch_to_19 = function $$dispatch_to($a_rest) {
          var self = this, args, $iter = TMP_dispatch_to_19.$$p, regulation = $iter || nil;
          ...
          if ($iter) TMP_dispatch_to_19.$$p = null;
          if ($truthy(Opal.const_get_relative($nesting, 'RUBY_ENGINE')['$!=']("opal"))) {
            return nil
            } else {
            return nil
          }
        }, TMP_dispatch_to_19.$$arity = -1);
        if ($truthy(Opal.const_get_relative($nesting, 'RUBY_ENGINE')['$!=']("opal"))) {
          nil};
        return (Opal.defn(self, '$dispatch_from_server', TMP_dispatch_from_server_21 = function $$dispatch_from_server(params_hash) {
          var TMP_20, self = this, params = nil;

          
          params = self.$_Railway().$params_wrapper().$new(self.$deserialize_dispatch(params_hash)).$lock();
          return $send(self.$_Railway().$receivers(), 'each', [], (TMP_20 = function(receiver){var self = TMP_20.$$s || this;
if (receiver == null) receiver = nil;
          return receiver.$call(params)}, TMP_20.$$s = self, TMP_20.$$arity = 1, TMP_20));
        }, TMP_dispatch_from_server_21.$$arity = 1), nil) && 'dispatch_from_server';
      })(Opal.get_singleton_class(self), $nesting)
    })($nesting[0], Opal.const_get_relative($nesting, 'Operation'), $nesting);
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_ControllerOp_method_missing_22;

      
      self.$inbound("controller");
      Opal.alias(self, "pre_controller_op_method_missing", "method_missing");
      return (Opal.defn(self, '$method_missing', TMP_ControllerOp_method_missing_22 = function $$method_missing(name, $a_rest) {
        var self = this, args, $iter = TMP_ControllerOp_method_missing_22.$$p, block = $iter || nil;
        ...
        if ($iter) TMP_ControllerOp_method_missing_22.$$p = null;
      ...
      }, TMP_ControllerOp_method_missing_22.$$arity = -2), nil) && 'method_missing';
