...
Opal.modules["hyperloop/router/mixin"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$class_eval', '$param', '$define_method', '$match', '$params', '$location', '$history', '$before_mount', '$listen', '$set_state', '$before_unmount', '$call']);
  return (function($base, $parent_nesting) {
    var $Hyperloop, self = $Hyperloop = $module($base, 'Hyperloop');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      return (function($base, $parent_nesting) {
        ...
        (function(self, $parent_nesting) {
          var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_included_8;

          return (Opal.defn(self, '$included', TMP_included_8 = function $$included(base) {
            var TMP_1, self = this;
            ...
            return $send(base, 'class_eval', [], (TMP_1 = function(){var self = TMP_1.$$s || this, TMP_2, TMP_3, TMP_4, TMP_5, TMP_7;
              ...
              $send(self, 'define_method', ["history"], (TMP_4 = function(){var self = TMP_4.$$s || this;

              return self.$params().$history()}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4));
              $send(self, 'before_mount', [], (TMP_5 = function(){var self = TMP_5.$$s || this, TMP_6;

              return (self._react_router_unlisten = $send(self.$history(), 'listen', [], (TMP_6 = function(location, action){var self = TMP_6.$$s || this;
if (location == null) location = nil;if (action == null) action = nil;
                return Opal.const_get_qualified(Opal.const_get_relative($nesting, 'React'), 'State').$set_state(Opal.const_get_relative($nesting, 'HyperRouter'), "location", location)}, TMP_6.$$s = self, TMP_6.$$arity = 2, TMP_6)))}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5));
              return $send(self, 'before_unmount', [], (TMP_7 = function(){var self = TMP_7.$$s || this;
              ...
              if ($truthy(self._react_router_unlisten)) {
                  ...
                  return nil
                }}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7));}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1));
