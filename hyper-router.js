...
Opal.modules["hyper-router/class_methods"] = function(Opal) {
  ...
  Opal.add_stubs(['$>', '$count', '$first', '$send', '$new', '$to_n', '$history', '$on_opal_server?', '$prerender_router', '$to_proc', '$render_router', '$private', '$create_browser_history', '$current', '$create_hash_history', '$create_memory_history', '$define_method', '$raise', '$Router', '$instance_eval', '$tap', '$split', '$request_fullpath', '$[]=', '$-', '$StaticRouter']);
  return (function($base, $parent_nesting) {
    var $HyperRouter, self = $HyperRouter = $module($base, 'HyperRouter');
      ...
      Opal.defn(self, '$render_router', TMP_ClassMethods_render_router_7 = function $$render_router() {
        ...
        return $send(self, 'define_method', ["render"], (TMP_8 = function(){var self = TMP_8.$$s || this, TMP_9;
          ...
          if ($truthy(self.$history())) {
            ...
            self.$raise(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'HyperRouter'), 'NoHistoryError'), "A history must be defined")
          };
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      return (function($base, $parent_nesting) {
        ...
        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Base_included_1;

        Opal.defs(self, '$included', TMP_Base_included_1 = function $$included(base) {
          var self = this;
...
/* Generated by Opal 0.11.0 */
(function(Opal) {
  var $a, self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $truthy = Opal.truthy, no_router_source = nil, no_router_dom_source = nil, error = nil;

  Opal.add_stubs(['$require', '$import', '$==', '$raise']);
  
  self.$require("hyper-component");
  Opal.const_get_relative($nesting, 'Hyperloop').$import("hyper-router/react-router-source");
  ...
  if (Opal.const_get_relative($nesting, 'RUBY_ENGINE')['$==']("opal")) {
    ...
    if ($truthy(($truthy($a = no_router_source) ? $a : no_router_dom_source))) {
